...
CONFIG = {
    ...
    'model_checkpoint': 'lightning_logs_classification_test1/lstm_v2_128_512_nlay4/checkpoints/epoch=30-step=86335.ckpt',
    # 'model_checkpoint': 'lightning_logs_classification_test1/lstm_v1/checkpoints/epoch=96-step=270145.ckpt',
}
