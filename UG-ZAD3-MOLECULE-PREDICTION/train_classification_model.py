    ...
    if part == 2:
        configs = [
            ...
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 2,
             'hidden_dim': 32, 'embedding_dim': 1, 'predictor_type': "MLP",
             'mlp_hidden_dim': 128, 'out_dim': 2, 'dropout_encoder': 0.1},
            # linear emb 1
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 2,
             'hidden_dim': 64, 'embedding_dim': 1, 'predictor_type': "Linear",
            ...
            # emb 16
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 2,
             'hidden_dim': 64, 'embedding_dim': 16, 'predictor_type': "MLP",
             'mlp_hidden_dim': 128, 'out_dim': 2, 'dropout_encoder': 0.1},
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 1,
             'hidden_dim': 128, 'embedding_dim': 16, 'predictor_type': "Linear",
             'mlp_hidden_dim': None, 'out_dim': 2, 'dropout_encoder': 0.1},
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 2,
            ...
            {'batch_size': 64, 'gnn_type': "GINE", 'num_layers': 2,
             ...
             'mlp_hidden_dim': None, 'out_dim': 2, 'dropout_encoder': 0.1},
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 4,
             'hidden_dim': 128, 'embedding_dim': 32, 'predictor_type': "MLP",
             'mlp_hidden_dim': 64, 'out_dim': 2, 'dropout_encoder': 0.1},
            {'batch_size': 64, 'gnn_type': "Transformer", 'num_layers': 1,
             'hidden_dim': 128, 'embedding_dim': 32, 'predictor_type': "Linear",
             'mlp_hidden_dim': None, 'out_dim': 2, 'dropout_encoder': 0.1},
        ]
